...
// Mock user database
const mockUsers: { [key: string]: { _id: string; username: string; password: string; balance: number; status: string } } = {};

// Simple password check (for demo purposes only)
const comparePassword = (plainPassword: string, hashedPassword: string): Promise<boolean> => {
